...
`
	...
	require.Len(t, sysexts, 2)
	assert.True(t, sysexts[0].OmitReference, "standalone-ext should omit reference")
	assert.False(t, sysexts[1].OmitReference, "merged-ext should not omit reference by default")
}
